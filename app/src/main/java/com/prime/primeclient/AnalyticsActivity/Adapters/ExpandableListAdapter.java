...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, ArrayList<TypeOne>> _listDataChild;

    public ExpandableListAdapter(Context context, ArrayList<String> listDataHeader,
                                 HashMap<String, ArrayList<TypeOne>> listChildData) {
    ...
    public Object getChild(int groupPosition, int childPosititon) {
        return String.valueOf(this._listDataChild.get(this._listDataHeader.get(groupPosition))
                .get(childPosititon).paymentAmount);
    }
